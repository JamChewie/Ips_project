...
int main()
{
	__cilkrts_end_cilk(); __cilkrts_set_param("nworkers", "2");					// Задаем количество потоков 
	...
	std::cout << "Duration is " << duration1.count() << " seconds" << std::endl;
